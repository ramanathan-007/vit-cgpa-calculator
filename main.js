...
const calcCgpa = document.querySelector("#calc-cgpa");
...
add.addEventListener("click", () => {
  if (
    ...
    calcCgpa.classList.remove("display-none");
...
calcCgpa.addEventListener("click", () => {
  ...
  tdTotalCredits.innerHTML = `your total credits is ${credits}`;
...
clear.addEventListener("click", () => {
  ...
  calcCgpa.classList.add("display-none");
